...
export const ZS_ALL_TOKENS = [
  ...
  DOT_DOT, AND_AND, OR_OR, EQUAL, NOT_EQUAL, LESS_EQUAL, GREATER_EQUAL, PLUS_ASSIGN, MINUS_ASSIGN, DIV_ASSIGN, MOD_ASSIGN, CAT_ASSIGN, XOR_ASSIGN, AND_ASSIGN, OR_ASSIGN,
  L_BRACKET, R_BRACKET, L_CURLY, R_CURLY, L_PAREN, R_PAREN, COMMA, DOT, SEMICOLON, COLON,
